...
namespace ProjectOfWebFormMVC.Models
{
    ...
    public class HondaContext
    {
        string cs = ConfigurationManager.ConnectionStrings["dbcs"].ConnectionString;

        public List<Honda> GetCars()
        {
            List<Honda> cars = new List<Honda>();
            SqlConnection conn = new SqlConnection(cs);
            SqlCommand cmd = new SqlCommand("select *from CAR_Reg where COMPONY_NAME='HONDA'", conn);
            conn.Open();
        ...
        public bool UpdateCars(Honda c)
        {
