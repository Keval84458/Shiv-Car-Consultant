...
namespace ProjectOfWebFormMVC.Models
{
    ...
    public class NissanContext
    {
        string cs = ConfigurationManager.ConnectionStrings["dbcs"].ConnectionString;

        public List<Nissan> GetCars()
        {
            List<Nissan> cars = new List<Nissan>();
            SqlConnection conn = new SqlConnection(cs);
            SqlCommand cmd = new SqlCommand("select *from CAR_Reg where COMPONY_NAME='NISSAN'", conn);
            conn.Open();
        ...
        public bool UpdateCars(Nissan c)
        {
