...
namespace ProjectOfWebFormMVC.Models
{
    ...
    public class VolkswagenContext
    {
        string cs = ConfigurationManager.ConnectionStrings["dbcs"].ConnectionString;

        public List<Volkswagen> GetCars()
        {
            List<Volkswagen> cars = new List<Volkswagen>();
            SqlConnection conn = new SqlConnection(cs);
            SqlCommand cmd = new SqlCommand("select *from CAR_Reg where COMPONY_NAME='VOLKSWAGEN'", conn);
            conn.Open();
        ...
        public bool UpdateCars(Volkswagen c)
        {
