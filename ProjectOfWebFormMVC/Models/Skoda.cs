...
namespace ProjectOfWebFormMVC.Models
{
    ...
    public class SkodaContext
    {
        string cs = ConfigurationManager.ConnectionStrings["dbcs"].ConnectionString;

        public List<Skoda> GetCars()
        {
            List<Skoda> cars = new List<Skoda>();
            SqlConnection conn = new SqlConnection(cs);
            SqlCommand cmd = new SqlCommand("select *from CAR_Reg where COMPONY_NAME='SKODA'", conn);
            conn.Open();
        ...
        public bool UpdateCars(Skoda c)
        {
