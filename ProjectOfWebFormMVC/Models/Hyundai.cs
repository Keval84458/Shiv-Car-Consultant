...
namespace ProjectOfWebFormMVC.Models
{
    ...
    public class HyundaiContext
    {
        string cs = ConfigurationManager.ConnectionStrings["dbcs"].ConnectionString;

        public List<Hyundai> GetCars()
        {
            List<Hyundai> cars = new List<Hyundai>();
            SqlConnection conn = new SqlConnection(cs);
            SqlCommand cmd = new SqlCommand("select *from CAR_Reg where COMPONY_NAME='HYUNDAI'", conn);
            conn.Open();
        ...
        public bool UpdateCars(Hyundai c)
        {
